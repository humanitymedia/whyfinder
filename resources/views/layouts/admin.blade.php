            ...
            <aside class="fixed inset-y-0 left-0 z-30 w-64 bg-brand-brown text-white transform transition-transform duration-200 ease-in-out lg:translate-x-0"
                ...
                <nav class="px-4 py-6 space-y-1">
                    ...
                    <a href="{{ route('admin.content.index') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('admin.content.*') ? 'bg-white/10 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">
